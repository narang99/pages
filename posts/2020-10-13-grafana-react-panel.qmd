...
description: developing a basic custom Graph Panel plugin for Grafana
categories: [Coding]
date: 'October 13, 2020'
aliases: 
  - /2020-10-13-grafana-react-panel
---
...
![Bar option selected for GraphPanel plugin](/assets/grafana-graph-panel-plugin/bar-option.webp){#fig-1}


![Line option selected for GraphPanel plugin](/assets/grafana-graph-panel-plugin/line-option.webp){#fig-2}
