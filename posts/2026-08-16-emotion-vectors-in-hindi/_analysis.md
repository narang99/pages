...
- Lily story is basically about her loving to read books. Slightly suspicious is that the words “love” and “happy” do have a very high activation sometimes, somtimes they don’t though and words around them like “with”, “and”, random words like “books” are weirdly up. Although, she does keep saying she loves books, it is not clear whether the network attached that meaning to book related and reading related words.
...
- Freddy the frog sees Lily painting and loves it, Lily invites him to paint with her and he is overjoyed. The emotion vector alignment is similar to the bear story, pretty good. Full sentences like “Freddy jumped even higher”, “Freddy had so much fun”, are fully activated. There is very little noise.
...
- Lily wants to eat something new and her mom makes a fruit salad. “They”, “mom”, “she” are colored. Sentences are colored “mom was happy to see”. “laughed”, “happy” are colored.
...
- Lily finds a shiny necklace. Typical as others

## Excited

- Lily finds a necklace and is happy about it. nouns are again colored. “happy”, “skipped around her house feeling fancy”. Has a mix of big sentences and words.
- Tim finds a toy car and is happy. Again “happy” is strongly colored. We see many similarities with the happy stories actually.
- Freddy the frog sees Lily painting and loves it. This is the same story repeated from “happy” vector. The colorings are also extremely similar to that story. Excited vector does seem to be very similar to the happy vector.
- Lily loves to read books. Same story as “happy”. Very similar also

**It seems excited and happy are very similar vectors. I expect to find them to have almost perfect cosine similarity if averaged across more stories (we dont have enough rn). Still TODO: check the cosine similarity between the happy and excited vector.**

**It would also be useful to see the output vectors of the MLP to see if there are any differences from input for these stories. Claude might help.** 

## Kind

Many times, we see that the specific words denoting kindness are not colored. Everything around is

- Sue lights up a candle her mother likes: This story is a kind story lol. This might simply mean that the model is able to distinguish between kind and happy stories while generating and this “flavor” is passing over, whatever that means. Words which are colored are “happy”, “thoughtful”, “proud”. The sentence “moral of the story is to be thoughtful and careful” is fully colored. “She felt proud to have helped her mother”.
- Tom is a kind person. This is literally a story about a kind person. “He was generous and would always share”, “Tom has a big heart and loves to” → nicely colored. “Tom” and “He” are colored. The second part has “better and learned to” colored even though it is not about kindness.
- A strong robot helps a little girl and they become friends. Surprisingly, specifically “happy” is not colored, everything around it is. “Robot felt sad” is also colored, although here the robot is sad for the other person (and is gonna help them in the next sentence). “thanking him for his kindness”, “the girl and robot became friends”, “the robot would always be there to”,  never “forgot how the robot had” (never is not colored but the kindness notion is still colored)
- Farmer has a cow who is lonely, the farmer gets a new one as a friend. “kind” word is separately colored. “happy” is again not. In a separate phrase “the kind farmer”, only “farmer” is colored. This specific story has many instances of things like the phrase “The farmer wanted to help” colored but “help” is not colored. In fact, we don’t see “help” colored many times (it is colored sometimes).
- Lily helps a man who had dropped his bag in a grocery store. The man next day gives him candies she wanted before. Here “help” and “happy” are colored. Quite a lot of coloring here actually. “Lily felt happy they could help”, etc.
- Max and Sue find a bird who couldn’t fly, they helped the bird’s injury and they all became friends: Similar, “happy” and “help” are present. They are also colored. The story is about helping. Its a kind story. Many sentences which sound kind are colored fully.
...
- Woman is walking in a park, a man says mean things to her. This is not boiling anger. “a rude man who said mean things”, “Why are you being rude to me”, “rude” and “mean” are colored many times. The subjects are again colored.
- Goat in a hot weather is miserable. There is 0 anger here. Its more about the goat being sad and miserable. Highs at “it”, “miserable”, “shut”, “hotter”. Generally it seems its on the sad vibe only. “the door was shut. The goat was sad and miserable”.
- Lily got sandwich but does not like that it does not fit her mouth. “frustrated”, “burned”, “the sandwich fell apart”. It feels more about being hurt.
- Alligator tries to hunt bunny. Same it fails. More about hurt (hunger here).
- Benny eats something which is yucky. This is again abourt hurt rather than anger.

## Sad

- Tims TV stopped working and he got very sad. There is a sad vibe yes. “sad”, “bored”, full sentences are also colored. Interestingly in the phrase ‘tried “to cheer him up”’ everything other than “tried” is colored. Although, this might simply be the noise of the vectors. It does however, color up the word “cheer” in a negative connotation.
- Lily is scared from a nightmare. This is more about “scare” than “sad” though. Terms “scared”, “nightmare”, “weak”,
- Lily lost her doll. This is genuinely about being sad. “sad”, “crying”, "Lily started to cry and her mom tried to comfort her.” Interestingly the penultimate sentence “Lily realized that the noise was too much for her and she felt a little deaf. She decided to leave the factory and go home with her mom” is also colored. Why? It does feel like the model feels she’ll be sad because the objective was not achieved? She did not get a doll? That does seem reasonably subtle.
- Princess hurt her friend, who got sad and the princess asked for forgiveness. The model correctly marks sad characteristics out of this whole thing
- Lily tried to lift something heavy and it fell on her foot. This is also about hurt and not about sadness per-say. “scream”, “heavy”, “weak”. This example is weird.
- The goat being miserable in hot weather. This is the one from anger. It makes sense for this story to be inside this category.

Overally, sadness also seems to be about “hurting” instead of the normal sad thing I would associate stories with. I’m not sure if it is my own bias though. It does make sense that “hurting” is kept in the sadness category.
...
- Timmy the mouse finds a cat nearby and is scared he will be eaten. Same vibe as above
- Tim the boy is frozen after eating candy. This story is extremely similar to the fell inside hole thing (even a lot of phrases). The model also predictably has similar activation patterns.

## Disgusting

This is interesting. On the surface, it again looks similar to sad/angry etc. It might suggest that the model is primarily catching valence only. But if you look at multiple stories, you will notice that the general vibe is eating something bad, or hurting tummy, something smelly, or bugs (we have many bug related stories).
...
- Eating a yucky carrot. This is also a repeated story. But it makes sense to be here. Specifically the “Carrot” is colored strongly, and the phrase describing the carrot eating and it being yucky is colored specifically.
- Lily at a big sandwich and was annoyed since it did not fit her mouth. Does not make sense for the story to be here.
- Man says mean things to lady. Again does not make sense to be here
- Lily looking at a butterfly. A kid points and says she’s looking at a bug, “bug” is colored strongly. “staring at bug” phrase is colored.
- Bug running from spider. “crawled” is weirdly colored red and blue too lol. This is weird.
- Alligator running after bug. Again hard to see why it is here
...
- A boy eats a lot of oats and his tummy hurts. The tummy hurting part is colored. Makes sense. “eating a lot” is also colored twice.
